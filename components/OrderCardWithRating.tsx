...
const OrderCardWithRating: React.FC<Props> = ({ item, onPress, onPressRating }) => {
        ...
        >
            <View className="flex-row items-start justify-between">
                <View className="flex-row p-1">
                    <Image
                        source={{ uri: `${process.env.EXPO_PUBLIC_LOCAL_SERVER}/images/bakery-image/${item.bakery.bakeryImage}` }}
...
export default OrderCardWithRating;
